                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                ...
                                <div class="max-w-4xl mx-auto p-8 mt-5">
                                    ...
                                    <div id="step-1" class="">
                                        <form class="space-y-6" action="{{ route('jobseeker.registration') }}" method="POST">
                                            @csrf
                                            <div>
                                            ...
                                            <div class="grid grid-cols-2 gap-6">
                                                <div>
                                                    ...
                                                    <input placeholder="Enter email" name="email" type="email" name="email" class="w-full border rounded-md p-2" value="{{ old('email', $email ?? '') }}" />
                                                    @error('email')
                                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="date" name="dob" class="w-full border rounded-md p-2" />
                                                     @error('dob')
                                                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="flex justify-end">
                                                <button type="submit" onclick="showStep(2)" class="bg-blue-700 text-white px-6 py-2 rounded-md">Next</button>
                                            </div>
                                        </form>
                                    </div>
